...
- THIS IS WHEN THE MEMBER'S OFFICE IS REBATED FOR EXPENSES. FOR EXAMPLE, MAYBE THE OFFICE CANCELLED A $1MIL CONTRACT WITH A VENDOR AFTER ONLY SPENDING 200K, SO A -800K RECORD WILL APPEAR.
...
```{r}
# For this question we actually will need the expenditure data for all members, not just DMV reps, to get an annual average we can compare to the DMV reps' average
