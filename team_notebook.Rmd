...
# Filter out all rows that pertain to totals/subtotals (easy for us to recalculate if needed, and this way we're not unintentionally doubling the true #'s of our findings when doing aggregations)
...
```{r}
# glimpse of the cleaned data set

glimpse(dmv_spend_with_member_info)
...
# The very top indeivdual expense was a nearly 100k maintenance/repair project in 2018 (reported in 2019) from Eleanor Jolmes Norton's office
