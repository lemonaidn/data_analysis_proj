...
# It looks like Democrats are generally spending more every year, with the exception of 2020 which may be an outlier because of the pandemic. But Republicans spent the most in 2018, the year they were in the majority. Otherwise the Republican spending trends similarly to Democrats (2022 followed by 2020, 2021, 2019).  

# So that answers the second part of our question. It looks like parties in power will spend more than normal. But let's also look a the spend proportionally. Are there more Dems or Reps over the 5 years? 
...
# There have been 17 Democrats representing the DMV over the past 5 years, in addition to 11 Republicans. Now let's look at average spend for a rep per year per party to compare if individual Democrats spend more than individual Republicans. 

#avg_spend_dmv <- totals_dmv_spend |> 
 # group_by(bioguide_id, last_name, first_name, party, year) |> 
 # mutate(total_spend = sum(amount))|> 
 # mutate (years_in_office = count(year))


# I feel like group_by is not doing what I need it to and I'm still seeing a bunch of columns I don't want. Also the count() function I maybe made up because it's not working. I asked ChaptGPT and it said this is another way to do that: 
...
# WHY IS GROUP_BY NOT WORKING!!!! I STILL HAVE A ROW FOR EVERY PURPOSE, WHEN I JUST WANT A ROW FOR EVERY REP (BIOGUIDE ID). WHAT THE FUDGE. 
...
spend_by_office |> 
 ...
 ## Elijah Cummings spend -$900.00 in 2021. Let's look at this spending overall to see if his office was reimbursed for a major contract of something. 
...
# That's interesting. He spent a over two million dollars in 2018-2019, and less thatn $25K in the following 2 years. Let's look at his spending by category. 

totals_dmv_spend |> 
  filter(last_name == "CUMMINGS" & first_name == "ELIJAH" & year == "2021")

# WELL WELL WELL. Elijah Cummings died in 2019. Yet his office had expenses in 2020 & 2021. We think that this is because of the delayed filing of expenses, as we can see inf the "office" column that the office was 2019 Hon. Elijah E. Cummings. 
